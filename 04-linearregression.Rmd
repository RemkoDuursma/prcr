...
```{r visreg1, opts.label="wide", fig.cap='Visualization of two fitted linear model with the visreg package. The model on the right includes an interaction between Process and Age.', warning=FALSE, message=FALSE, echo=-1}
par(mfrow=c(1,2))
library(visreg)
