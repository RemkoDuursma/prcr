...
- methods for many variables: select subset of predictors, make model 'stable'
...
- stabilize variance
- but also: now we have a multiplicative model!
...
ggpubr::ggarrange(residPlot(lm1), 
                  residPlot(lm2)) %>% plot
...
### Quadratic and polynomial terms {#quadlm}
