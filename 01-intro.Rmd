...
If you would like to practice reading data from CSV files (as described in Section \@ref(readcsv)), you can also download (nearly) every example dataset from HERE.
